...
import { asset, cv, LINKS, SITE } from '@/content/cv';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: '/og.png', width: 1200, height: 630, alt: 'Abdelhamid Attaby, Staff Software Engineer' }],
  },
  twitter: {
    ...
    <html lang="en">
      ...
      <body>
        ...
        <div
          ...
          aria-hidden="true"
          style={{ backgroundImage: `url(${asset('/circuit.svg')})` }}
        />
        <div className="bg-lights" aria-hidden="true"><span /><span /><span /></div>
        {children}
      </body>
    </html>
  );
